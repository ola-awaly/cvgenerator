...
@Component({
  selector: 'app-dialogue-edit-experience',
  templateUrl: './dialogue-edit-experience.component.html',
  styleUrls: ['./dialogue-edit-experience.component.scss']
})
export class DialogueEditExperienceComponent implements OnInit {
  ...
  constructor( private _formBuilder: FormBuilder, 
               ...
               public dialogRef: MatDialogRef<DialogueEditExperienceComponent>,
   ...
   // console.log(this.parcoursFormGroup.value);
    ...
    const obs=forkJoin(
      section.experiences.map(
        exp=>
        exp.id?
        this._experienceapi.update(exp.id,exp)
        :
        this._experienceapi.new(exp)
        ))
     obs.subscribe({
       next: (data: any[])=>{
         console.log("over");
